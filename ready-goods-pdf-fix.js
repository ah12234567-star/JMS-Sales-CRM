...
(function(){
  ...
  function pdfCss(){return `
    html,body{margin:0!important;padding:0!important;width:794px!important;min-width:794px!important;max-width:794px!important;background:#fff!important;direction:ltr!important;overflow:hidden!important}
    *{box-sizing:border-box}
    .rgn-pdf-doc{width:794px!important;min-height:1123px!important;max-width:794px!important;background:#fff!important;color:#0f172a!important;padding:46px 48px 40px!important;margin:0!important;font-family:Cairo,Arial,sans-serif!important;direction:rtl!important;position:relative!important;transform:none!important}
  ...
  async function makeBlob(n){
    ...
    frame.style.cssText='position:fixed;left:-10000px;top:0;width:794px;height:1123px;border:0;opacity:0;pointer-events:none;direction:ltr;';
    document.body.appendChild(frame);
    try{
      const d=frame.contentDocument;
      d.open();
      d.write(`<!doctype html><html dir="ltr"><head><meta charset="utf-8"><style>${pdfCss()}</style></head><body>${noticeHtml(n)}</body></html>`);
      d.close();
  ...
  function install(){
    ...
    window.JMSReadyGoods.__pdfFix='20260816-production-4';
  }
